...
import 'package:learn_getx_flutter/dependency_management/class.dart';
import 'package:learn_getx_flutter/dependency_management/controller.dart';
import 'package:learn_getx_flutter/dependency_management/detail_page.dart';
    ...
    return GetMaterialApp(
      ...
      getPages: [
        GetPage(
          name: '/detail',
          page: () => DetailPage(),
          //binding: DetailsBinding(),  /// Bind the COntroller with The View (BEst)
          binding: BindingsBuilder(
            () {
              ...
              /// Create new instance every time, not Singleton, here below 2 Times it will created.
